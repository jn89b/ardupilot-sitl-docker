...
SITL_PKGS="libtool libxml2-dev libxslt1-dev python3-dev python3-pip python3-setuptools python3-numpy python3-pyparsing python3-psutil python3.12-venv"
...
python -m pip install --progress-bar off future lxml pymavlink pyserial MAVProxy pexpect geocoder empy==3.3.4 ptyprocess dronecan map opencv-python 
